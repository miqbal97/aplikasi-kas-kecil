 ...
 */
public class Rekapitulasi_Pengeluaran extends javax.swing.JDialog {
     ...
     */
    public Rekapitulasi_Pengeluaran() {
        initComponents();
        this.get_data_table();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rekapitulasi_Pengeluaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Rekapitulasi_Pengeluaran dialog = new Rekapitulasi_Pengeluaran();
    ...
    private void report(){
        try {
            String file = "src\\Rekapitulasi\\Rekapitulasi_Pengeluaran.jasper";
