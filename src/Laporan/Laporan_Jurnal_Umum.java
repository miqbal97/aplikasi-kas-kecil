...
public class Laporan_Jurnal_Umum extends javax.swing.JDialog {
    ...
    private void get_data_table(){
        final String[] _label = {"Tanggal", "No Nota", "Keterangan", "Debit", "Kredit"};
        try {
            ResultSet result = db.runQuery("SELECT tanggal, no_pengisian, keterangan, jumlah, terpakai "
    ...
    private void get_data_table_filtered_by_date(){
        ...
        try {
            ResultSet result = db.runQuery("SELECT tanggal, no_pengisian, keterangan, jumlah, terpakai "
                                         + "FROM pembentukan_dana WHERE tanggal BETWEEN '"+f_from.getText()+"' AND '"+f_to.getText()+"'");
